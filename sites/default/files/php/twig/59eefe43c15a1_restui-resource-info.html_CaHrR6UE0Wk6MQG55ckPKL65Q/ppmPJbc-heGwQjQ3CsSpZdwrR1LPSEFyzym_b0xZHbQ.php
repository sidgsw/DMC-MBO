...
class __TwigTemplate_73102a23fabf811198b35e7f1e66faf993443cb11a3f3798681200f194ab286e extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (((isset($context["granularity"]) ? $context["granularity"] : null) == "resource")) {
            // line 16
            echo "    <p>methods: ";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_join_filter($this->getAttribute((isset($context["configuration"]) ? $context["configuration"] : null), "methods", array()), ", "), "html", null, true));
            echo "</br>
        formats: ";
            // line 17
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_join_filter($this->getAttribute((isset($context["configuration"]) ? $context["configuration"] : null), "formats", array()), ", "), "html", null, true));
            echo "</br>
        authentication: ";
            // line 18
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_join_filter($this->getAttribute((isset($context["configuration"]) ? $context["configuration"] : null), "authentication", array()), ", "), "html", null, true));
            echo "
    </p>
";
        } else {
    ...
    {
        return new Twig_Source("", "modules/contrib/restui/templates/restui-resource-info.html.twig", "/Applications/MAMP/htdocs/dmc/modules/contrib/restui/templates/restui-resource-info.html.twig");
    }
}
